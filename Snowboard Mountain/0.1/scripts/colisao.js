...
class Forma {
    ...
    constructor(posicao, raio, vertices) {
...
function colidem(objeto) {
    ...
    objeto.partes.forEach(function (parte) {
        if (parte.colide) {
            ...
            let forma = new Forma([objeto.x + parte.posicao[0], objeto.y + parte.posicao[1]], parte.raio, parte.vertices);
            formas.push(forma);
        }
    });
    return formas;
...
function verificarColisao(forma1, forma2) {
    ...
    if (forma1.raio > 0 && forma2.raio >0) {
        ...
        return verificarCirculos (forma1, forma2);
...
function verificar(objeto1, objeto2) {
    ...
    for (forma1 of formas1) {
        ...
        for (forma2 of formas2) {
            ...
            if(verificarColisao(forma1, forma2)) {
                return true;
            }
